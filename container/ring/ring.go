...
// This implementation is based on the standard ring package.
package ring
...
// A Ring[T] is an element of a circular list, or ring.
// Ring[T]s do not have a beginning or end; a pointer to any ring element
// serves as reference to the entire ring. Empty rings are represented
// as nil Ring[T] pointers. The zero value for a Ring[T] is a one-element
